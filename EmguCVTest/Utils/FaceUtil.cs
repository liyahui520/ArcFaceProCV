...
namespace EmguCVTest.Utils
{
    public class FaceUtil
    {
        ...
        /// <param name="multiFaceInfo">人脸检测结果</param>
        /// <returns>面积最大的人脸信息</returns>
        public static List<ASF_SingleFaceInfo> GetAllFaces(ASF_MultiFaceInfo multiFaceInfo)
        {
            List<ASF_SingleFaceInfo> list = new List<ASF_SingleFaceInfo>();
